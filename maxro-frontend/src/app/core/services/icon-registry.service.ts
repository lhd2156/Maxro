...
export class IconRegistryService {
  ...
  private readonly icons: Record<string, string> = {
    ...
    'mx-utensils': `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M7 3v5a3 3 0 006 0V3"/>
        <path d="M10 3v18"/>
        <path d="M17 3l-1 7h3l-1-7"/>
        <path d="M18 10v11"/>
      </svg>`,
    'mx-droplet': `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    'mx-flame': `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M12 2c.5 3.5-1 6-3 8 2 0 4 1.5 4.5 4 .5-2.5 2-4.5 3.5-6C15 10 14 6 12 2z"/>
        <path d="M12 22a7 7 0 01-5-8.5c1 2.5 3 4 5 4s4-1.5 5-4A7 7 0 0112 22z"/>
      </svg>`,
    'mx-check-circle': `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    'mx-glass': `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M6 3h12l-1.5 13a3 3 0 01-3 2.5h-3A3 3 0 017.5 16L6 3z"/>
        <path d="M6 8h12"/>
      </svg>`,
    'mx-plus': `
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
